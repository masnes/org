...
*** Product Team Meeting
* Globalyzer Lite
** WAIT [#1] [6/10] Get Lite release ready                          :status meeting:
...
*** TODO [#4] [6/7] Any licensing stuff for Lite
...
*** regi [#1] [4/4] Internal Docs                            :status meeting:
...
**** DONE [#1] [7/9] Document use of plugin for Lite
CLOSED: [2015-11-10 Tue 11:18] DEADLINE: <2015-11-06 Fri>
...
CLOSED: [2015-11-04 Wed 19:32]
***** TODO [#1] Check that the Docs contains links to the demo videos
***** TODO [#1] Doc review session. Need to fix merge stuff.
...
**** done [#1] (Olivier) Russ needs information about the Prep Kit setup
CLOSED: [2015-11-06 Fri 11:37] DEADLINE: <2015-11-06 Fri>
**** done [#2] Respond to Paypal's questions on feature requests
CLOSED: [2015-11-10 Tue 11:20] SCHEDULED: <2015-11-09 Mon>
**** WAIT [#2] Workbench only installation setup for Russ
Use it doc at https://docs.google.com/document/d/1TFtXLVwBrnN6b_MgQOdY_2-FyA2wtc6noKcYem4I0l4
***** DONE [#2] Get Admin Access to the Globalyzer Server
...
** TODO [#2] Look into stack installer
** Clients
*** Pre-Sale
**** Amex
