...
*** WAIT [#2] Start Blackbaud install once server is up         :Blackbaud:
...
Rally
AutoDesk
** Dec  7th Company Meeting
*** TODO [#2] Send Lori Password
...
**** WAIT [#1] Get Jenkins Setup Scripts to the FTP server        :Intuit:
John wants to be able to do this himself. So guide him through it to the 
point where he understands.
**** DONE [#1] Get Lite put on the FTP server                     :Intuit:
CLOSED: [2015-12-02 Wed 17:07]
*** Rule set config
